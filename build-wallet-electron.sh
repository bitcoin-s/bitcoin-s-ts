...
if [[ $Chip == 'arm64' ]]; then 
	...
	curl -O -L https://github.com/bitcoin-s/bitcoin-s/releases/download/1.9.3/bitcoin-s-server-macosx-1.9.3.zip
elif [[ $OS == 'Windows' ]]; then
	curl -O -L https://github.com/bitcoin-s/bitcoin-s/releases/download/1.9.3/bitcoin-s-server-windowsserver2022-1.9.3.zip
elif [[ $OS == 'Linux' ]]; then
	curl -O -L https://github.com/bitcoin-s/bitcoin-s/releases/download/1.9.3/bitcoin-s-server-linux-1.9.3.zip
