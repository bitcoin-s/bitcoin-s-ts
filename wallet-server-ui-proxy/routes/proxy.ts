...
//   /** Data Routes */
//   router.get('/buildConfig', buildController.get(logger))
...
//   router.post('/downloadBackup', express.json(), verifyAuth, 
//     require('../middleware/backup').downloadBackup(logger, Config.backupDirectory));
// }
